    ...
    <x-slot:right-side>
        ...
        <x-navbar.item id="apps" text="View other links of the application">
            ...
            <x-slot:dropdown>
                ...
                <x-navbar.dropdown big-square header="Apps">
                    ...
                    <x-navbar.dropdown.link href="#" text="Sales">
                    ...
                    <x-navbar.dropdown.link href="#" text="Users">
                    ...
                    <x-navbar.dropdown.link href="#" text="Inbox">
                    ...
                    <x-navbar.dropdown.link href="#" text="Profile">
                    ...
                    <x-navbar.dropdown.link href="#" text="Settings">
                    ...
                    <x-navbar.dropdown.link href="#" text="Products">
                    ...
                    <x-navbar.dropdown.link href="#" text="Pricing">
                    ...
                    <x-navbar.dropdown.link href="#" text="Billing">
                    ...
                    <x-navbar.dropdown.link href="#" text="Logout">
        ...
        <x-navbar.item user id="user" text="Open user menu">
            ...
            <x-slot:dropdown>
                ...
                <x-navbar.dropdown>
                    <x-slot:header href="#">
                        <x-navbar.dropdown.user-info name="Neil Sims" email="name@flowbite.com"/>
                    </x-slot:header>

                    <x-navbar.dropdown.link href="#">My profile</x-navbar.dropdown.link>

                    <x-navbar.dropdown.link href="#">Account settings</x-navbar.dropdown.link>
